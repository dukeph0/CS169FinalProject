...
void
wifiTx (std::string context, Ptr< const Packet > packet, double txPowerW){
 NS_LOG_UNCOND (packet << " " << txPowerW);
}
...
main (int argc, char *argv[])
{
  ...
  Config::Connect ("/NodeList/*/DeviceList/*/$ns3::WifiNetDevice/Phy/PhyBegin", MakeCallback (&wifiTx));
